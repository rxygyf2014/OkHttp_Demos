...
//        String mBaseUrl = "http://192.168.0.165:8080/FileUpload/FileUploadServlet";
        String mBaseUrl = "http://172.25.26.77:8080/FileUpload/FileUploadServlet";
        File file = new File(Environment.getExternalStorageDirectory(), "image.jpg");
        File file2 = new File(Environment.getExternalStorageDirectory(), "pdf11.pdf");
        if (!file.exists() || !file2.exists()) {
            Toast.makeText(OKHttpActivity.this, "文件不存在，请修改文件路径", Toast.LENGTH_SHORT).show();
            return;
        }
        Map<String, String> params = new HashMap<>();
        params.put("username", "阮晓勇");
